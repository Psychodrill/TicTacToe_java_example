...
public class Map extends JPanel {
    ...
    private static final int STATI_WIN_AI=2;

    private static final String MSG_WIN_HUMAN = "Player wins!";
    ...
    private void update(MouseEvent e){
       ...
       aiTurn();
       repaint();
       if(checkEndGame(AI_DOT, STATI_WIN_AI))return;
    }
    ...
    private void showMessageGameOver(Graphics g){
        ...
        g.setFont(new Font("Palette", Font.BOLD, 48));
        switch(gameOverType){
            case STATE_DRAW:
